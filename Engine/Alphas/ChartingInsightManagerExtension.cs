                ...
                try
                {
                    ...
                    if (_statisticsManager.RollingAverageIsReady)
                    {
                        ...
                        Log.Trace($"ChartingInsightManagerExtension.Step(): Sampled charts. Next sample: {_nextChartSampleAlgorithmTimeUtc}. " +
                            $"Direction Count: {_insightScoreSeriesByScoreType[InsightScoreType.Direction].Values.Count} " +
                            $"Magnitude Count: {_insightScoreSeriesByScoreType[InsightScoreType.Magnitude].Values.Count}");
                    }
                    else
                    {
